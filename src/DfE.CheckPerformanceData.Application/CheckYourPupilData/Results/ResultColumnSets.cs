...
/// agreed columns plus the current grade, so a school can see what a result holds before it says
/// the grade is wrong; the CSV adds the result detail the table has no room for. Subject is the
