...
///
/// The grade is appended because the school is choosing which grade is wrong: without it the
/// options name the qualification but not the result, and the school has to pick blind.
///
