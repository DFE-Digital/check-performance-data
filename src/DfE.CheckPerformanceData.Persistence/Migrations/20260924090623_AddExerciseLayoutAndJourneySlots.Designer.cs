...
namespace DfE.CheckPerformanceData.Persistence.Migrations
{
    ...
    [Migration("20260924090623_AddExerciseLayoutAndJourneySlots")]
    partial class AddExerciseLayoutAndJourneySlots
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DfE.CheckPerformanceData.Persistence.Entities.CheckingWindow", b =>
                {
                    ...
                    b.Property<DateTime?>("NextOpportunity")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("DfE.CheckPerformanceData.Persistence.Entities.EgressRemoveLearner", b =>
                {
                    ...
                    b.Property<string>("RemovalYear0")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.Property<string>("RemovalYear1")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.Property<string>("RemovalYear2")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
