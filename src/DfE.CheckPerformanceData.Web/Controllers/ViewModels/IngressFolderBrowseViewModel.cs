...
public class IngressFolderBrowseViewModel
{
    ...
    /// <summary>
    /// The checking exercise that consumes this dataset, by id (#466). Part of every link on
    /// the page, because a dataset name is only unique within one exercise.
    /// </summary>
    public Guid ExerciseId { get; init; }

    /// <summary>Route prefix shared by every link and the form action on this page.</summary>
    public string BaseUrl => $"/admin/windows/{WindowId}/exercises/{ExerciseId}/ingress-file/{Dataset}";
}