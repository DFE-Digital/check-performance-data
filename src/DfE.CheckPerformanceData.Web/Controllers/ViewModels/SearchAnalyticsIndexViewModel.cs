...
// and the empty-state guard (HasData = TotalRowCount >= 20). TotalRowCount is a separate
// field from Summary.TotalCount because the empty-state view still wants to say "we have
// N rows below the threshold" without re-running the aggregate.
