module "application_configuration" {
  ...
  secret_variables = {
    ...
    ZendeskSettings__Email           = module.infrastructure_secrets.map.ZendeskSettings__Email
    ZendeskSettings__ApiToken        = module.infrastructure_secrets.map.ZendeskSettings__ApiToken
  }
}
