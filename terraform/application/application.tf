module "application_configuration" {
  ...
  secret_variables = {
    ...
    ZendeskSettings__Email           = module.infrastructure_secrets.map.ZENDESK-API-EMAIL
    ZendeskSettings__ApiToken        = module.infrastructure_secrets.map.ZENDESK-API-TOKEN
  }
}
