...
public class StartDateControllerTests
{
    ...
    public async Task New_get_returns_bad_request_when_no_session_data()
    {
        ...
        IActionResult result = await controller.NewStartDate(CancellationToken.None);
    ...
    public async Task New_post_returns_bad_request_when_no_session_data()
    {
        ...
        IActionResult result = await controller.SubmitNew(model, CancellationToken.None);
    ...
    public async Task Edit_get_returns_view_with_the_windows_start_date()
    {
        ...
        IActionResult result = await controller.EditStartDate(id, CancellationToken.None);
    ...
    public async Task Edit_post_updates_the_window_and_redirects_to_summary()
    {
        ...
        IActionResult result = await controller.SubmitEdit(id, model, CancellationToken.None);
    ...
    public async Task Edit_post_returns_bad_request_when_route_id_does_not_match_model()
    {
        ...
        IActionResult result = await controller.SubmitEdit(routeId, model, CancellationToken.None);
